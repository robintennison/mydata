...
interface CombinedAssetPieChartProps {
  accounts: any[];
  deposits: any[];
  adjustments: any[];
...
const CombinedAssetPieChart: React.FC<CombinedAssetPieChartProps> = ({
  accounts,
  deposits,
  adjustments,
  showInactive = false,
  ...
  const chartData = useMemo(() => {
    ...
    // Filter out accounts with 0 assets for the pie chart clarity
...
export default CombinedAssetPieChart;
