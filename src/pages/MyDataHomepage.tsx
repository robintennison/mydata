...
import { calculateEMW, getEmwSettings } from "../modules/Home/utils/emwCalculations";
...
import { LiabilityHistory } from "../modules/Banking/types/banking.types";
import { OnlineItem } from "../modules/Online/types/online.types"; // Import the official interface
...
const MyDataHomepage: React.FC = () => {
  ...
  // State for online items (using imported OnlineItem type)
  ...
  // Fetch online items using the OnlineItem type
  useEffect(() => {
